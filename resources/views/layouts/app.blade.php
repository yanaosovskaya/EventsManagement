    ...
    <div id="app">
        <header>
            @if(View::hasSection('header'))
                @yield('header')
            @elseif(!\App\Models\Menu::whereCode('main')->exists())
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('contact-form.create') }}">{{ __('Contact') }}</a>
                                </li>
            ...
            @else
                @widget('menu', [
                    'code' => 'main',
                    'class' => 'navbar-expand-md navbar-light navbar-laravel',
                    'brand' => [
